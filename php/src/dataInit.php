...
function ponuda(){
    ...
    $insert = "INSERT INTO ponuda (id_ponude,termin_polazak, termin_povratak, cena_putovanja, cena_prevoza, id_lokacije_polaska, id_prevoza) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    $conn->query("UPDATE ponuda SET ponuda.termin_polazak = ponuda.termin_polazak - INTERVAL (100) DAY, ponuda.termin_povratak= ponuda.termin_povratak - INTERVAL (100) DAY WHERE ponuda.id_ponude>24378 AND ponuda.id_ponude<34378;");
    CloseCon($conn);
    provodi();
}
